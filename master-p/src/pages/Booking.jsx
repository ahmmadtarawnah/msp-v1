    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gray-100 py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-[#2B3B3A] text-center mb-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                ...
                of your consultation. A representative will contact you to
                confirm the appointment and answer any questions.
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-bold text-[#2B3B3A] mb-2">
                Can I change or cancel my consultation?
              </h3>
              <p className="text-gray-600">
                Yes, you can change or cancel your consultation up to 24 hours
                before the scheduled time without any charge. Please contact our
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Consultations typically last between 45-60 minutes, depending on
                the complexity of your case and the type of consultation you've
                selected.
              </p>
            </div>
          </div>
