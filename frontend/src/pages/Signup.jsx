        ...
        <div className="flex-grow flex justify-center items-center px-4">
          <div className="w-full max-w-md">
            <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-lg">
              <div className="p-12">
                <span className="block text-xl text-[#DECEB0] mb-6">Create your account</span>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-semibold text-[#DECEB0] mb-2">
                      Full Name
                    </label>
                    <input
                      id="name"
                  ...
                  <div>
                    <label htmlFor="password" className="block text-sm font-semibold text-[#DECEB0] mb-2">
                      Password
                    </label>
                    <input
                      id="password"
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="terms" className="ml-2 block text-sm text-[#DECEB0]">
                      I agree to the{" "}
                      <Link to="#" className="text-[#DECEB0] hover:text-white">
                        Terms of Service
                      </Link>{" "}
                      and{" "}
                      <Link to="#" className="text-[#DECEB0] hover:text-white">
            ...
            <div className="mt-6 text-center">
              <span className="text-[#DECEB0]">
                ...
                <Link to="/Login" className="text-[#DECEB0] hover:text-white">
                  Sign in
                </Link>
              </span>
